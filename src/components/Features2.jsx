...
const Features2 = () => {
  const features = [
    {
      icon: <FaSyncAlt />,
      title: '24X7 Hosting Support',
      text: 'Our tech-support team is always here to help over email, chat and phone across the year, at any time',
    },
    {
      icon: <FaCloud />,
    ...
    },
    {
      ...
      text: 'Our blazing fast and reliable shared hosting plans come with a 30-day money back guarantee',
    },
    {
      icon: <FaLock />,
      title: 'Global Server Locations',
      text: 'Our servers are present across 5 major locations – US, UK, India and Hong Kong and Netherland.',
    },
    {
      icon: <FaRocket />,
      title: 'Free DNS Management',
      text: 'Users can use our name servers as their own branded name servers using our free DNS Management service',
    },
    {
      icon: <FaLifeRing />,
      title: 'Softaculous',
      text: 'Install over 300 applications and scripts including WordPress, Joomla, Drupal, Magento',
    },
  ];
